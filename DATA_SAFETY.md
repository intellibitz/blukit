...
| **Vibes** | Only on your phone | Only with people you sync with | To keep your local vibe history. |
| **Location** | No | No | Needed for hardware discovery on some phones, but we never track your position. |
| **Device ID** | No | No | We generate a random ID on your phone to find other people nearby. |

## 2. Security

**Everything you send is encrypted.**

- **Vibe Security**: All your vibes are scrambled using advanced security (**AES-256**) so only the intended person can read them.
- **Private Keys**: Your phone makes secret keys that stay on your phone to keep your private vibes safe.

## 3. Your Privacy

- **No Cloud**: Your vibes never go to the internet or a cloud server. They stay within about 100 meters of you.
