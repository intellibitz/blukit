...
3.  Locate the following previews:
    -   `PreviewRadarPhone`: The main **Sensing Radar** showing the full-screen **Resonance Stream** overlaid on the atmospheric **Resonance Field**. Features the centralized context anchor, prominent identity anchor ("YOU"), and the unified Resonance header. Includes the AI-driven **Atmospheric Heatmap** and **Aura Glow**.
    ...
    -   `PreviewTimelineField`: The visual life journey showing shared **Records** in **The Ledger**.
    ...
    -   `PreviewResonanceTickerHeaders`: High-density stream showcasing varied Echo types and resonance counts.
...
## 🚀 Pro Tip
For the **Feature Graphic**, use a dark background (#000000) with **Stealth Rose** (#FF4081) and **Amber** (#FFB300) typography to reflect the **Rose Resonance** and **Unified Echo Frequency**.
