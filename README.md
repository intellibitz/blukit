...
- **Harmony Top Bar**: A unified system dashboard managing navigation (ALL/MINE), noise filtering, hardware radios, and environment settings in a sleek 3-row architecture.
- **Wear OS Support**: Native Wear OS app to see nearby vibes directly on your wrist with high-efficiency scaling lists.
- **Grounded Hub**: Minimalist bottom anchor for high-priority vibe input, hosting the merged `V I (B) E S` branding and Privacy bar.
