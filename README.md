# blukit: the atmospheric mesh

**SPREAD (B) VIBES. VIBE ANYWHERE.**

blukit is built for the **Crowd**, not the **Web**. It is a 100% offline, peer-to-peer **Media Mesh** that lets you spread vibes, share media, and establish secure ties in any physical environment—festivals, subways, air hubs, or universities—without a single byte touching the internet.
...
### **Air Hub (Top)**
- **Row 0 (Global Command)**: Tactical toggles for Stealth/Power + **BLUKIT PRIVACY** protocol link + Real-time radio status.
- **Row 1 (Humanity Stage)**: Minimalist navigation, centered **Air Title** (showing deep paths like `AIR > TIE`), and right-anchored **Profile Persona**.

### **Interaction Hub (Bottom)**
*Available only inside an Air or Tie*
- **Vibe Hub**: Once you dive in, the interaction hub awakens.
- **Discovery Radar**: Integrated directly into the input widget. Toggles between Spreading and Searching.
